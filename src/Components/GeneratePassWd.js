...
const GeneratePassWd = () => {
  const [output, setOutput] = useState("Chose Your Favorite Password ");
  ...
  return (
    <div className="container">
      <h2>Easy Password Generator</h2>
      <input type="text" value={output} className="output" disabled />
      <button className="Copy">Copy</button><br></br>
      <br />
      ...
      Click Here For Generate PasssWord
      </button>
    </div>
  );
};
